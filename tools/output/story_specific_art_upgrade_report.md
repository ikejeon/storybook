...
- Premium scenes rendered: 558
- Premium covers rendered: 19
- Character sheets rendered: 24
- Contact sheet: `tools/output/story_specific_art_contact_sheet.png`

## Replaced Selected Renderers

- `local_story_specific_svg_renderer`: 577
